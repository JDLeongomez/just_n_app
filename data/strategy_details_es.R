...
strategy_details_es <- list(
  ...
  intro_importance = function() tagList(

    p("Justificar el tamaño de muestra antes de recolectar datos muestra que el
    ...
    p("En investigación cualitativa, aunque las lógicas son distintas, se pide cada
    ...
    p("Hoy es cada vez más común que revistas, guías de reporte y comités éticos
       incluyan la justificación de tamaño muestral entre sus requisitos, y cuando se
       usa pre-registro o formatos como ", tags$em("registered reports"),
  ...
  what_is_power = function() tagList(
    ...
    p("El poder depende de varios factores: aumenta cuando el tamaño de muestra es
  ...
  # ── sesoi ───────────────────────────────────────────────────────────────────
  sesoi = function() tagList(

    p("El SESOI (", tags$em("Smallest Effect Size of Interest"),
       ") es el tamaño más pequeño de efecto que se considera relevante o que
    ...
    p(tags$strong("El SESOI se decide, no se descubre automáticamente."),
      ...
      tags$table(class = "table table-sm table-bordered",
        ...
        tags$tbody(
          tags$tr(
            ...
            tags$td(cite_ref("riesthuisExpertOpinionsSmallest2021"), " ",
          ...
          tags$tr(
            ...
            tags$td(cite_ref("dickMeaningfulAssociationsRedux2025"), " ",
                    cite_ref("anvariUsingAnchorbasedMethods2021"), " ",
                    cite_ref("carlsonEffectsTrainingLoad2022"))
          ),
          tags$tr(
            ...
            tags$td(cite_ref("lakensEquivalenceTestingPsychological2018"), " ",
    ...
    p("Si no puedes definir un SESOI a priori, usa meta-análisis o revisiones
       sistemáticas de alta calidad (con corrección de sesgo de publicación)
       como estimación conservadora — nunca un único estudio piloto o previo",
       ...
       " en la sección de calculadoras cuantitativas para más detalles.")
  ),

  # ── prior ───────────────────────────────────────────────────────────────────
  prior = function() tagList(

    p("Usar el tamaño de efecto de un único estudio previo o de un estudio piloto como
    ...
    p("Una alternativa práctica para evaluar si un resultado de replicación es compatible
    ...
    p("Si el nuevo efecto no es significativo o es tan pequeño que el estudio original
  ...
  # ── saturation ──────────────────────────────────────────────────────────────
  saturation = function() tagList(

    p("En investigación cualitativa, la saturación teórica es el punto del análisis en
    ...
    p("Es un proceso gradual, no un instante exacto: el investigador, analizando de
      ...
      tags$table(class = "table table-sm table-bordered",
        ...
        tags$tbody(
          tags$tr(
            ...
            tags$td(cite_ref("nelsonUsingConceptualDepth2017"), " ",
          ...
          tags$tr(
            ...
            tags$td("Análisis"),
            tags$td(cite_ref("saunders2018saturation"), " ",
                    cite_ref("mouraMethodologicalPathReach2022"), " ",
    ...
    p("Para evaluar la saturación de forma sistemática y reproducible, se ha
  ...
  # ── diversity ───────────────────────────────────────────────────────────────
  diversity = function() tagList(

    p("En investigación cualitativa, el tamaño de muestra no se calcula por fórmulas
    ...
    tags$small(class = "text-muted fst-italic d-block my-2",
    ...
    p("En metodología Q, las personas participantes se seleccionan para representar la
    ...
    p("La “representatividad” se entiende como que cada perspectiva identificada
    ...
    div(class = "card jn-example-card mt-3",
      div(class = "card-header py-2",
          tags$strong("Ejemplo de aplicación")),
      div(class = "card-body py-2",
        p("En un estudio cualitativo sobre la experiencia de cuidar a un familiar con
  ...
  # ── community ───────────────────────────────────────────────────────────────
  community = function() tagList(

    p("En la investigación cualitativa con muestreo guiado por la comunidad
    ...
    p("Israel y colegas destacan que, en investigación participativa comunitaria, se
    ...
    p(class = "text-muted small fst-italic mt-1",
      tags$strong("Nota: "),
    ...
    p("El tamaño de muestra en este enfoque se decide ", tags$strong("colaborativamente"),
  ...
  # ── narrative ───────────────────────────────────────────────────────────────
  narrative = function() tagList(

    p("En investigación cualitativa, el tamaño de muestra se decide menos por
    ...
    p("En este enfoque se construye una ", tags$em("narrativa de diseño"),
    ...
    p("El papel de la narrativa es guiar el razonamiento del lector sobre qué es posible,
  ...
  # ── ethics ──────────────────────────────────────────────────────────────────
  ethics = function() tagList(

    p("En investigación cualitativa, el tamaño de muestra no se fija por fórmulas
    ...
    p("Desde una perspectiva ética, ampliar o reducir la muestra implica impactos directos
    ...
    div(class = "card jn-example-card mt-3",
      div(class = "card-header py-2",
          tags$strong("Ejemplo de aplicación")),
      div(class = "card-body py-2",
        p("En un estudio sobre la experiencia de médicos de familia frente al burnout, una
  ...
  # ── mixed ───────────────────────────────────────────────────────────────────
  mixed = function() tagList(

    p("En diseños mixtos, la complementariedad implica que los datos cuantitativos y
    ...
    p("La complementariedad se diferencia de la triangulación (que busca convergencia) y
    ...
    p("Teddlie y Yu plantean que el muestreo mixto combina estrategias probabilísticas y
      ...
      tags$table(class = "table table-sm table-bordered",
        ...
        tags$tbody(
          tags$tr(
            ...
            tags$td(cite_ref("Javdani2023Mixed"), " ",
                    cite_ref("Teddlie2016Mixed"), " ",
                    cite_ref("creswell2018mixed"))
          ),
          tags$tr(
  ...
  # ── precision ────────────────────────────────────────────────────────────────
  precision = function() tagList(

    p("La estrategia de tamaño de muestra basada en precisión busca que el
    ...
    p("Este enfoque es especialmente adecuado para estudios descriptivos, donde
...
n_por_precision(epsilon = 0.10)  # \u2248 387 participantes"),
    ...
    div(class = "card jn-example-card mt-3",
      ...
      div(class = "card-body py-2",
        p("Una investigadora quiere estimar la correlación entre ansiedad rasgo y
  ...
  # ── sequential ───────────────────────────────────────────────────────────────
  sequential = function() tagList(

    p("Los diseños secuenciales (o adaptativos) permiten realizar análisis
    ...
    div(class = "alert alert-warning d-flex gap-2 align-items-start small mt-2",
      tags$span("\u26a0\ufe0f"),
      div(
...
diseno$upper$bound  # valores Z críticos para detención anticipada"),
  ...
  cost = function() tagList(
    ...
    p("Cuando los recursos son severamente limitados, la estrategia consiste
    ...
    p("Dado el N máximo disponible, se calcula el efecto mínimo detectable
...
pwr.t.test(n = 50, d = 0.30, sig.level = 0.05,
    ...
    p("El paquete ", tags$code("retrodesign"),
...
# exaggeration: factor de exageración del efecto si el resultado es significativo"),
    ...
    div(class = "card jn-example-card mt-3",
      div(class = "card-header py-2", tags$strong("Ejemplo de aplicación")),
      div(class = "card-body py-2",
        p("Un investigador realiza un estudio piloto con 20 participantes por
