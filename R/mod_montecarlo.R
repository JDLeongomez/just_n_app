      ...
      div(
        ...
        div(
          ...
          bslib::card(
            ...
            bslib::card_body(
              p(HTML(paste0(
                "Los paquetes analíticos como <code>pwr</code> asumen distribuciones ",
                "paramétricas y diseños sencillos. La simulación Monte Carlo es la opción ",
              ...
              div(
                ...
                lapply(
                  c(
                    "Modelos mixtos (lme4)", "ANCOVA / covariables",
                    "Diseños factoriales complejos", "Distribuciones no normales",
                    "Medidas repetidas", "Cualquier diseño personalizado"
                  ),
                  function(x) {
                    div(
                      class = "col-md-4",
          ...
          bslib::card(
            ...
            bslib::card_body(
              ...
              step_card(
                ...
                "El poder ≈ proporción de simulaciones en que se rechaza H₀."
              )
            )
          ),
          ...
          bslib::card(
            ...
            bslib::card_body(
              p(class = "mb-0", HTML(paste0(
                ...
                "<a href='https://lme4.github.io/lme4/reference/simulate.merMod.html' target='_blank'><code>lme4::simulate()</code></a> o generando datos con la estructura ",
                "de efectos fijos y aleatorios esperada. Para <strong>ANCOVA</strong>, ",
                "incluye la covariable en la simulación. Para <strong>diseños factoriales</strong>, ",
                "genera datos con los efectos principales e interacciones de interés. ",
                "El principio es siempre el mismo: simular \u2192 aplicar test \u2192 contar rechazos."
              )))
            )
          ),

          # Diseños factoriales con Superpower
          bslib::card(
            bslib::card_header(
              div(
                class = "d-flex align-items-center gap-2",
                bsicons::bs_icon("grid-fill", style = "color:#4f46e5"),
                "Diseños factoriales: el paquete Superpower"
              )
            ),
            bslib::card_body(
              p(HTML(paste0(
              ...
              h6("1. Definir el diseño con ", tags$code("ANOVA_design()"),
                 class = "mt-3 mb-1"),
              div(class = "jn-code-block mb-3",
"library(Superpower)
...
diseno <- ANOVA_design(
  ...
  labelnames = c(\"grupo\", \"control\", \"experimental\",
              ...
              h6("2. Estimar el poder con ", tags$code("ANOVA_power()"),
                 class = "mb-1"),
              div(class = "jn-code-block mb-3",
